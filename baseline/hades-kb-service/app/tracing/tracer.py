...
if app_config.environment == "dev":
    ...
    processor = OTLPGRPCSpanExporter(endpoint=app_config.otel_exporter_otlp_endpoint)
logger.info(f"spans will be sent to {app_config.otel_exporter_otlp_endpoint}")
