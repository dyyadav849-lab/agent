...
INSERT INTO `zion`.`agent_plugin` (
    ...
    '1.0',
    'kibana_pre_orchestrator',
    'Pre ocherstrator Kibana Log Search',
    'This is preorchestrator for kibana log search',
    'Preinstruction for kibana tool',
    'orchestrator',
    '{
        "access_control": {
            "agents": {
...
DELETE FROM
  `zion`.`agent_plugin`
WHERE
  `name_for_model` = 'kibana_pre_orchestrator';
